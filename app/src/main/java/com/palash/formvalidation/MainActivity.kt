package com.palash.formvalidation
...
import com.palash.formvalidation.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    private val formIsValid = combine(
        ...
        errorMessage = when {
            emailIsValid.not() -> "please enter email"
            passwordIsValid.not() -> "please enter password and password length 7-15"
            passwordAgainIsValid.not() -> "passwords again"
            else -> null
        }
        errorMessage?.let {
